<?php
// HTTP
define('HTTP_SERVER', 'http://online-shop-example-project.apps.ir-thr-mn1.arvan.run/admin/');
define('HTTP_CATALOG', 'http://online-shop-example-project.apps.ir-thr-mn1.arvan.run/');

// HTTPS
define('HTTPS_SERVER', 'http://online-shop-example-project.apps.ir-thr-mn1.arvan.run/admin/');
define('HTTPS_CATALOG', 'http://online-shop-example-project.apps.ir-thr-mn1.arvan.run/');
...
define('DB_HOSTNAME', 'mysql-svc');
define('DB_USERNAME', 'root');
define('DB_PASSWORD', 'notsecured');
