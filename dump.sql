...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 11, 2020 at 01:13 PM
...
--
-- Table structure for table `ek_address`
--
...
--
-- Table structure for table `ek_affiliate`
--

CREATE TABLE `ek_affiliate` (
...
--
-- Table structure for table `ek_affiliate_activity`
--

CREATE TABLE `ek_affiliate_activity` (
...
--
-- Table structure for table `ek_affiliate_login`
--

CREATE TABLE `ek_affiliate_login` (
...
--
-- Table structure for table `ek_affiliate_transaction`
--

CREATE TABLE `ek_affiliate_transaction` (
...
--
-- Table structure for table `ek_api`
--
...
--
-- Dumping data for table `ek_api`
--

INSERT INTO `ek_api` (`api_id`, `username`, `firstname`, `lastname`, `password`, `status`, `date_added`, `date_modified`) VALUES
(1, 'U4TgrwjGPrhc4tOl1CIuKYqkfjkbd11VcJyODdN2ZDmzEeWxWUcAxstgj8XKAxvR', '', '', '', 1, '2020-02-11 12:43:43', '2020-02-11 12:43:43');

-- --------------------------------------------------------

--
-- Table structure for table `ek_attribute`
--

CREATE TABLE `ek_attribute` (
...
--
-- Dumping data for table `ek_attribute`
--

INSERT INTO `ek_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- Table structure for table `ek_attribute_description`
--

CREATE TABLE `ek_attribute_description` (
  `attribute_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ek_attribute_description`
--

INSERT INTO `ek_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 2, 'توضیحات'),
(2, 2, 'تعداد هسته'),
(4, 2, 'تست 1'),
(5, 2, 'تست 2'),
...
--
-- Table structure for table `ek_attribute_group`
--

CREATE TABLE `ek_attribute_group` (
  `attribute_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ek_attribute_group`
--

INSERT INTO `ek_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Table structure for table `ek_attribute_group_description`
--

CREATE TABLE `ek_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `ek_attribute_group_description`
--

INSERT INTO `ek_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(4, 1, 'Technical'),
(3, 2, 'حافظه'),
(4, 2, 'فنی'),
(5, 2, 'مادربرد'),
...
--
-- Table structure for table `ek_banner`
--

CREATE TABLE `ek_banner` (
...
--
-- Dumping data for table `ek_banner`
--

INSERT INTO `ek_banner` (`banner_id`, `name`, `status`) VALUES
(6, 'محصولات اچ پی', 1),
...
--
-- Table structure for table `ek_banner_image`
--

CREATE TABLE `ek_banner_image` (
...
--
-- Dumping data for table `ek_banner_image`
--

INSERT INTO `ek_banner_image` (`banner_image_id`, `banner_id`, `link`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `ek_banner_image_description`
--

CREATE TABLE `ek_banner_image_description` (
  `banner_image_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `banner_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ek_banner_image_description`
--

INSERT INTO `ek_banner_image_description` (`banner_image_id`, `language_id`, `banner_id`, `title`) VALUES
(114, 2, 7, 'مک بوک ایر'),
(122, 1, 8, 'NFL'),
(122, 2, 8, 'NFL'),
(121, 1, 8, 'RedBull'),
...
--
-- Table structure for table `ek_category`
--
...
--
-- Dumping data for table `ek_category`
--

INSERT INTO `ek_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `ek_category_description`
--

CREATE TABLE `ek_category_description` (
  `category_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ek_category_description`
--

INSERT INTO `ek_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Table structure for table `ek_category_filter`
--

CREATE TABLE `ek_category_filter` (
  `category_id` int(11) NOT NULL,
...
--
-- Table structure for table `ek_category_path`
--

CREATE TABLE `ek_category_path` (
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ek_category_path`
--

INSERT INTO `ek_category_path` (`category_id`, `path_id`, `level`) VALUES
(25, 25, 0),
(28, 25, 0),
(28, 28, 1),
(35, 28, 1),
...
--
-- Table structure for table `ek_category_to_layout`
--

CREATE TABLE `ek_category_to_layout` (
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ek_category_to_layout`
--

INSERT INTO `ek_category_to_layout` (`category_id`, `store_id`, `layout_id`) VALUES
(33, 0, 0),
(20, 0, 0),
(34, 0, 0),
(27, 0, 0),
...
--
-- Table structure for table `ek_category_to_store`
--

CREATE TABLE `ek_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ek_category_to_store`
--

INSERT INTO `ek_category_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
--
-- Table structure for table `ek_country`
--

CREATE TABLE `ek_country` (
  `country_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ek_country`
--

INSERT INTO `ek_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
(101, 'جمهوری اسلامی ایران', 'IR', 'IRN', '', 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `ek_coupon`
--

CREATE TABLE `ek_coupon` (
...
--
-- Dumping data for table `ek_coupon`
--

INSERT INTO `ek_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `ek_coupon_category`
--

CREATE TABLE `ek_coupon_category` (
  `coupon_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ek_coupon_history`
--

CREATE TABLE `ek_coupon_history` (
...
--
-- Table structure for table `ek_coupon_product`
--

CREATE TABLE `ek_coupon_product` (
...
--
-- Table structure for table `ek_currency`
--

CREATE TABLE `ek_currency` (
...
--
-- Dumping data for table `ek_currency`
--

INSERT INTO `ek_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
...
--
-- Table structure for table `ek_customer_activity`
--

CREATE TABLE `ek_customer_activity` (
  `activity_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `key` varchar(64) NOT NULL,
  `data` text NOT NULL,
...
--
-- Table structure for table `ek_customer_ban_ip`
--

CREATE TABLE `ek_customer_ban_ip` (
...
--
-- Table structure for table `ek_customer_group`
--

CREATE TABLE `ek_customer_group` (
  `customer_group_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ek_customer_group`
--

INSERT INTO `ek_customer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
(1, 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `ek_customer_group_description`
--

CREATE TABLE `ek_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ek_customer_group_description`
--

INSERT INTO `ek_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
...
--
-- Table structure for table `ek_customer_history`
--

CREATE TABLE `ek_customer_history` (
...
--
-- Table structure for table `ek_customer_ip`
--

CREATE TABLE `ek_customer_ip` (
...
--
-- Table structure for table `ek_customer_login`
--

CREATE TABLE `ek_customer_login` (
...
--
-- Table structure for table `ek_customer_online`
--

CREATE TABLE `ek_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
--
-- Table structure for table `ek_customer_reward`
--

CREATE TABLE `ek_customer_reward` (
...
--
-- Table structure for table `ek_customer_transaction`
--

CREATE TABLE `ek_customer_transaction` (
...
--
-- Table structure for table `ek_custom_field`
--

CREATE TABLE `ek_custom_field` (
...
--
-- Table structure for table `ek_custom_field_customer_group`
--

CREATE TABLE `ek_custom_field_customer_group` (
  `custom_field_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
--
-- Table structure for table `ek_custom_field_description`
--

CREATE TABLE `ek_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ek_custom_field_value`
--

CREATE TABLE `ek_custom_field_value` (
...
--
-- Table structure for table `ek_custom_field_value_description`
--

CREATE TABLE `ek_custom_field_value_description` (
  `custom_field_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `custom_field_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
...
--
-- Table structure for table `ek_download`
--

CREATE TABLE `ek_download` (
...
--
-- Table structure for table `ek_download_description`
--

CREATE TABLE `ek_download_description` (
  `download_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ek_event`
--

CREATE TABLE `ek_event` (
...
--
-- Table structure for table `ek_extension`
--

CREATE TABLE `ek_extension` (
...
--
-- Dumping data for table `ek_extension`
--

INSERT INTO `ek_extension` (`extension_id`, `type`, `code`) VALUES
(23, 'payment', 'cod'),
(22, 'total', 'shipping'),
(57, 'total', 'sub_total'),
(58, 'total', 'tax'),
...
--
-- Table structure for table `ek_filter`
--

CREATE TABLE `ek_filter` (
  `filter_id` int(11) NOT NULL,
...
--
-- Table structure for table `ek_filter_description`
--

CREATE TABLE `ek_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
...
--
-- Table structure for table `ek_filter_group`
--

CREATE TABLE `ek_filter_group` (
  `filter_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ek_filter_group_description`
--

CREATE TABLE `ek_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ek_geo_zone`
--

CREATE TABLE `ek_geo_zone` (
...
--
-- Dumping data for table `ek_geo_zone`
--

INSERT INTO `ek_geo_zone` (`geo_zone_id`, `name`, `description`, `date_modified`, `date_added`) VALUES
...
--
-- Table structure for table `ek_information`
--

CREATE TABLE `ek_information` (
...
--
-- Dumping data for table `ek_information`
--

INSERT INTO `ek_information` (`information_id`, `bottom`, `sort_order`, `status`) VALUES
(3, 1, 3, 1),
(4, 1, 1, 1),
(5, 1, 4, 1),
(6, 1, 2, 1);
...
--
-- Table structure for table `ek_information_description`
--

CREATE TABLE `ek_information_description` (
  `information_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(64) NOT NULL,
  `description` text NOT NULL,
...
--
-- Dumping data for table `ek_information_description`
--

INSERT INTO `ek_information_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Table structure for table `ek_information_to_layout`
--

CREATE TABLE `ek_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `ek_information_to_layout`
--

INSERT INTO `ek_information_to_layout` (`information_id`, `store_id`, `layout_id`) VALUES
(5, 0, 0),
(3, 0, 0),
(6, 0, 0),
(4, 0, 0);
...
--
-- Table structure for table `ek_information_to_store`
--

CREATE TABLE `ek_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ek_information_to_store`
--

INSERT INTO `ek_information_to_store` (`information_id`, `store_id`) VALUES
(3, 0),
(4, 0),
(5, 0),
(6, 0);
...
--
-- Table structure for table `ek_language`
--

CREATE TABLE `ek_language` (
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL,
...
--
-- Dumping data for table `ek_language`
--

INSERT INTO `ek_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `sort_order`, `status`) VALUES
...
--
-- Table structure for table `ek_layout`
--

CREATE TABLE `ek_layout` (
  `layout_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ek_layout`
--

INSERT INTO `ek_layout` (`layout_id`, `name`) VALUES
(1, 'صفحه اصلی (Home)'),
(2, 'کالا (Product)'),
...
--
-- Table structure for table `ek_layout_module`
--

CREATE TABLE `ek_layout_module` (
...
--
-- Dumping data for table `ek_layout_module`
--

INSERT INTO `ek_layout_module` (`layout_module_id`, `layout_id`, `code`, `position`, `sort_order`) VALUES
...
--
-- Table structure for table `ek_layout_route`
--

CREATE TABLE `ek_layout_route` (
...
--
-- Dumping data for table `ek_layout_route`
--

INSERT INTO `ek_layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(69, 6, 0, 'account/%'),
(67, 10, 0, 'affiliate/%'),
...
--
-- Table structure for table `ek_length_class`
--

CREATE TABLE `ek_length_class` (
  `length_class_id` int(11) NOT NULL,
  `value` decimal(15,8) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ek_length_class`
--

INSERT INTO `ek_length_class` (`length_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '10.00000000'),
(3, '0.39370000');
...
--
-- Table structure for table `ek_length_class_description`
--

CREATE TABLE `ek_length_class_description` (
  `length_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
...
--
-- Dumping data for table `ek_length_class_description`
--

INSERT INTO `ek_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 2, 'سانتی متر', 'cm'),
(2, 2, 'میلی متر', 'mm'),
(3, 2, 'اینچ', 'in'),
(3, 1, 'Inch', 'in'),
...
--
-- Table structure for table `ek_location`
--

CREATE TABLE `ek_location` (
...
--
-- Table structure for table `ek_manufacturer`
--

CREATE TABLE `ek_manufacturer` (
...
--
-- Dumping data for table `ek_manufacturer`
--

INSERT INTO `ek_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `ek_manufacturer_to_store`
--

CREATE TABLE `ek_manufacturer_to_store` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ek_manufacturer_to_store`
--

INSERT INTO `ek_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Table structure for table `ek_marketing`
--

CREATE TABLE `ek_marketing` (
...
--
-- Table structure for table `ek_modification`
--

CREATE TABLE `ek_modification` (
...
--
-- Dumping data for table `ek_modification`
--

INSERT INTO `ek_modification` (`modification_id`, `name`, `code`, `author`, `version`, `link`, `xml`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `ek_module`
--

CREATE TABLE `ek_module` (
...
--
-- Dumping data for table `ek_module`
--

INSERT INTO `ek_module` (`module_id`, `name`, `code`, `setting`) VALUES
...
--
-- Table structure for table `ek_option`
--

CREATE TABLE `ek_option` (
...
--
-- Dumping data for table `ek_option`
--

INSERT INTO `ek_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 1),
(2, 'checkbox', 2),
(4, 'text', 3),
(5, 'select', 4),
...
--
-- Table structure for table `ek_option_description`
--

CREATE TABLE `ek_option_description` (
  `option_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `ek_option_description`
--

INSERT INTO `ek_option_description` (`option_id`, `language_id`, `name`) VALUES
(4, 1, 'Text'),
(6, 1, 'Textarea'),
(1, 2, ' دکمه رادیو'),
(2, 2, 'چک باکس '),
...
--
-- Table structure for table `ek_option_value`
--

CREATE TABLE `ek_option_value` (
...
--
-- Dumping data for table `ek_option_value`
--

INSERT INTO `ek_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(43, 1, '', 3),
(31, 1, '', 2),
(45, 2, '', 4),
(44, 2, '', 3),
...
--
-- Table structure for table `ek_option_value_description`
--

CREATE TABLE `ek_option_value_description` (
  `option_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
...
--
-- Dumping data for table `ek_option_value_description`
--

INSERT INTO `ek_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(31, 1, 1, 'Medium'),
(44, 2, 2, 'چک باکس 3'),
(31, 2, 1, 'متوسط'),
(41, 1, 5, 'Green'),
...
--
-- Table structure for table `ek_order`
--
...
--
-- Table structure for table `ek_order_custom_field`
--

CREATE TABLE `ek_order_custom_field` (
...
--
-- Table structure for table `ek_order_history`
--

CREATE TABLE `ek_order_history` (
...
--
-- Table structure for table `ek_order_option`
--

CREATE TABLE `ek_order_option` (
...
--
-- Table structure for table `ek_order_product`
--

CREATE TABLE `ek_order_product` (
  `order_product_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Table structure for table `ek_order_recurring`
--

CREATE TABLE `ek_order_recurring` (
...
--
-- Table structure for table `ek_order_recurring_transaction`
--

CREATE TABLE `ek_order_recurring_transaction` (
...
--
-- Table structure for table `ek_order_status`
--

CREATE TABLE `ek_order_status` (
  `order_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `ek_order_status`
--

INSERT INTO `ek_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(2, 2, 'در دست اقدام'),
(3, 2, 'حمل شده'),
(7, 2, 'لغو شده'),
(5, 2, 'کامل شده'),
...
--
-- Table structure for table `ek_order_total`
--

CREATE TABLE `ek_order_total` (
...
--
-- Table structure for table `ek_order_voucher`
--

CREATE TABLE `ek_order_voucher` (
...
INSERT INTO `ek_product` (`product_id`, `model`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `viewed`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `ek_product_attribute`
--

CREATE TABLE `ek_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` text NOT NULL
...
--
-- Dumping data for table `ek_product_attribute`
--

INSERT INTO `ek_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(47, 2, 1, '4'),
(43, 2, 1, '1'),
(42, 3, 1, '100mhz'),
(43, 4, 2, '8gb'),
...
--
-- Table structure for table `ek_product_description`
--

CREATE TABLE `ek_product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
--
-- Dumping data for table `ek_product_description`
--

INSERT INTO `ek_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Table structure for table `ek_product_discount`
--

CREATE TABLE `ek_product_discount` (
...
--
-- Dumping data for table `ek_product_discount`
--

INSERT INTO `ek_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Table structure for table `ek_product_filter`
--

CREATE TABLE `ek_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ek_product_image`
--

CREATE TABLE `ek_product_image` (
...
--
-- Dumping data for table `ek_product_image`
--

INSERT INTO `ek_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `ek_product_option`
--

CREATE TABLE `ek_product_option` (
  `product_option_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL,
  `value` text NOT NULL,
...
--
-- Dumping data for table `ek_product_option`
--

INSERT INTO `ek_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(224, 35, 11, '', 1),
...
--
-- Table structure for table `ek_product_option_value`
--

CREATE TABLE `ek_product_option_value` (
...
--
-- Dumping data for table `ek_product_option_value`
--

INSERT INTO `ek_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
--
-- Table structure for table `ek_product_recurring`
--

CREATE TABLE `ek_product_recurring` (
  `product_id` int(11) NOT NULL,
  `recurring_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ek_product_related`
--

CREATE TABLE `ek_product_related` (
  `product_id` int(11) NOT NULL,
  `related_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ek_product_related`
--

INSERT INTO `ek_product_related` (`product_id`, `related_id`) VALUES
(40, 42),
(41, 42),
(42, 40),
(42, 41);
...
--
-- Table structure for table `ek_product_reward`
--

CREATE TABLE `ek_product_reward` (
...
--
-- Dumping data for table `ek_product_reward`
--

INSERT INTO `ek_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(555, 42, 1, 100),
(546, 47, 1, 300),
(554, 28, 1, 400),
(551, 43, 1, 600),
...
--
-- Table structure for table `ek_product_special`
--

CREATE TABLE `ek_product_special` (
...
--
-- Dumping data for table `ek_product_special`
--

INSERT INTO `ek_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Table structure for table `ek_product_to_category`
--

CREATE TABLE `ek_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ek_product_to_category`
--

INSERT INTO `ek_product_to_category` (`product_id`, `category_id`) VALUES
(28, 20),
(28, 24),
(30, 20),
(30, 33),
...
--
-- Table structure for table `ek_product_to_download`
--

CREATE TABLE `ek_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ek_product_to_layout`
--

CREATE TABLE `ek_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `ek_product_to_layout`
--

INSERT INTO `ek_product_to_layout` (`product_id`, `store_id`, `layout_id`) VALUES
(41, 0, 0),
(34, 0, 0),
(48, 0, 0),
(40, 0, 0),
...
--
-- Table structure for table `ek_product_to_store`
--

CREATE TABLE `ek_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ek_product_to_store`
--

INSERT INTO `ek_product_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(30, 0),
(31, 0),
(32, 0),
...
--
-- Table structure for table `ek_recurring`
--

CREATE TABLE `ek_recurring` (
  `recurring_id` int(11) NOT NULL,
...
--
-- Table structure for table `ek_recurring_description`
--

CREATE TABLE `ek_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `ek_return`
--

CREATE TABLE `ek_return` (
...
--
-- Table structure for table `ek_return_action`
--

CREATE TABLE `ek_return_action` (
  `return_action_id` int(11) NOT NULL,
...
--
-- Dumping data for table `ek_return_action`
--

INSERT INTO `ek_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1, 2, 'برگردانده شد'),
(2, 2, 'اعتبار صادر شد'),
...
--
-- Table structure for table `ek_return_history`
--

CREATE TABLE `ek_return_history` (
...
--
-- Table structure for table `ek_return_reason`
--

CREATE TABLE `ek_return_reason` (
  `return_reason_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL DEFAULT '0',
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `ek_return_reason`
--

INSERT INTO `ek_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
...
--
-- Table structure for table `ek_return_status`
--

CREATE TABLE `ek_return_status` (
  `return_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL DEFAULT '0',
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `ek_return_status`
--

INSERT INTO `ek_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, 2, 'در حال بررسی'),
(3, 2, 'کامل شده'),
(2, 2, 'در انتظار کالا'),
(3, 1, 'Complete'),
...
--
-- Table structure for table `ek_review`
--
...
--
-- Table structure for table `ek_setting`
--

CREATE TABLE `ek_setting` (
...
--
-- Dumping data for table `ek_setting`
--

INSERT INTO `ek_setting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
...
(1481, 0, 'config', 'config_mail_smtp_hostname', '', 0),
(1482, 0, 'config', 'config_mail_smtp_username', '', 0),
(1483, 0, 'config', 'config_mail_smtp_password', '', 0),
(1484, 0, 'config', 'config_mail_smtp_port', '25', 0),
(1485, 0, 'config', 'config_mail_smtp_timeout', '5', 0),
(1486, 0, 'config', 'config_mail_alert', '', 0),
(1487, 0, 'config', 'config_secure', '0', 0),
(1488, 0, 'config', 'config_shared', '0', 0),
(1489, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai\'hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
...
(1480, 0, 'config', 'config_mail_parameter', '', 0),
(1479, 0, 'config', 'config_mail_protocol', 'mail', 0),
(1478, 0, 'config', 'config_ftp_status', '0', 0),
(1477, 0, 'config', 'config_ftp_root', '', 0),
(1476, 0, 'config', 'config_ftp_password', '', 0),
(1475, 0, 'config', 'config_ftp_username', '', 0),
(1474, 0, 'config', 'config_ftp_port', '21', 0),
(1473, 0, 'config', 'config_ftp_hostname', '127.0.0.1', 0),
(1472, 0, 'config', 'config_image_location_height', '50', 0),
(1471, 0, 'config', 'config_image_location_width', '268', 0),
(1470, 0, 'config', 'config_image_cart_height', '47', 0),
(1469, 0, 'config', 'config_image_cart_width', '47', 0),
(1468, 0, 'config', 'config_image_wishlist_height', '47', 0),
(1467, 0, 'config', 'config_image_wishlist_width', '47', 0),
(1466, 0, 'config', 'config_image_compare_height', '90', 0),
(1465, 0, 'config', 'config_image_compare_width', '90', 0),
(1464, 0, 'config', 'config_image_related_height', '200', 0),
(1463, 0, 'config', 'config_image_related_width', '200', 0),
(1462, 0, 'config', 'config_image_additional_height', '74', 0),
(1461, 0, 'config', 'config_image_additional_width', '74', 0),
(1460, 0, 'config', 'config_image_product_height', '228', 0),
(1459, 0, 'config', 'config_image_product_width', '228', 0),
(1458, 0, 'config', 'config_image_popup_height', '500', 0),
(1457, 0, 'config', 'config_image_popup_width', '500', 0),
(1456, 0, 'config', 'config_image_thumb_height', '228', 0),
(1455, 0, 'config', 'config_image_thumb_width', '228', 0),
(1454, 0, 'config', 'config_image_category_height', '80', 0),
(1453, 0, 'config', 'config_image_category_width', '80', 0),
(1452, 0, 'config', 'config_icon', 'catalog/cart.png', 0),
(1451, 0, 'config', 'config_logo', 'catalog/ErfanKala.png', 0),
(1450, 0, 'config', 'config_return_status_id', '2', 0),
(1449, 0, 'config', 'config_return_id', '0', 0),
(1448, 0, 'config', 'config_affiliate_mail', '0', 0),
(1447, 0, 'config', 'config_affiliate_id', '4', 0),
(1446, 0, 'config', 'config_affiliate_commission', '5', 0),
(1445, 0, 'config', 'config_affiliate_auto', '0', 0),
(1444, 0, 'config', 'config_affiliate_approval', '0', 0),
(1443, 0, 'config', 'config_stock_checkout', '0', 0),
(1442, 0, 'config', 'config_stock_warning', '0', 0),
(1441, 0, 'config', 'config_stock_display', '0', 0),
(1440, 0, 'config', 'config_order_mail', '0', 0),
(1439, 0, 'config', 'config_complete_status', 'a:1:{i:0;s:1:\"5\";}', 1),
(1438, 0, 'config', 'config_processing_status', 'a:1:{i:0;s:1:\"2\";}', 1),
(1437, 0, 'config', 'config_order_status_id', '1', 0),
(1436, 0, 'config', 'config_checkout_id', '5', 0),
(1435, 0, 'config', 'config_checkout_guest', '1', 0),
(1434, 0, 'config', 'config_cart_weight', '1', 0),
(1433, 0, 'config', 'config_api_id', '1', 0),
(1432, 0, 'config', 'config_invoice_prefix', 'INV-2015-00', 0),
(1431, 0, 'config', 'config_account_mail', '0', 0),
(1430, 0, 'config', 'config_account_id', '3', 0),
(1429, 0, 'config', 'config_login_attempts', '5', 0),
(1428, 0, 'config', 'config_customer_price', '0', 0),
(1427, 0, 'config', 'config_customer_group_display', 'a:1:{i:0;s:1:\"1\";}', 1),
(1426, 0, 'config', 'config_customer_group_id', '1', 0),
(1425, 0, 'config', 'config_customer_online', '0', 0),
(1424, 0, 'config', 'config_tax_customer', 'shipping', 0),
(1420, 0, 'config', 'config_voucher_min', '1000', 0),
(1421, 0, 'config', 'config_voucher_max', '10000', 0),
(1422, 0, 'config', 'config_tax', '1', 0),
(1423, 0, 'config', 'config_tax_default', 'shipping', 0),
(1419, 0, 'config', 'config_review_mail', '0', 0),
(1418, 0, 'config', 'config_review_guest', '1', 0),
(1417, 0, 'config', 'config_review_status', '1', 0),
(1416, 0, 'config', 'config_limit_admin', '20', 0),
(1415, 0, 'config', 'config_product_description_length', '150', 0),
(1412, 0, 'config', 'config_weight_class_id', '1', 0),
(1413, 0, 'config', 'config_product_count', '1', 0),
(1414, 0, 'config', 'config_product_limit', '15', 0),
(1411, 0, 'config', 'config_length_class_id', '1', 0),
(1410, 0, 'config', 'config_currency_auto', '0', 0),
(1409, 0, 'config', 'config_currency', 'TOM', 0),
(1408, 0, 'config', 'config_admin_language', 'fa', 0),
(1405, 0, 'config', 'config_country_id', '101', 0),
(1406, 0, 'config', 'config_zone_id', '1538', 0),
(1407, 0, 'config', 'config_language', 'fa', 0),
(1399, 0, 'config', 'config_comment', '', 0),
(1400, 0, 'config', 'config_meta_title', 'فروشگاه شما قدرت گرفته از اپن کارت فارسی', 0),
(1401, 0, 'config', 'config_meta_description', 'توضیحی مختصر در مورد فروشگاه در این بخش نوشته شود. این توضیحات در جستجوی گوگل خیلی موثر می باشد.', 0),
(1402, 0, 'config', 'config_meta_keyword', '', 0),
(1403, 0, 'config', 'config_template', 'default', 0),
(1404, 0, 'config', 'config_layout_id', '4', 0),
(1398, 0, 'config', 'config_open', '9 - 13 و 15.30- 18', 0),
(1397, 0, 'config', 'config_image', '', 0),
(1396, 0, 'config', 'config_fax', '', 0),
(1395, 0, 'config', 'config_telephone', '123456789', 0),
(1394, 0, 'config', 'config_email', 'smd@smd.smd', 0),
(1393, 0, 'config', 'config_geocode', 'TEH', 0),
(1392, 0, 'config', 'config_address', 'آدرس فروشگاه در این محل درج شود. \r\n(قدرت گرفته از اپن کارت فارسی)', 0),
(1391, 0, 'config', 'config_owner', 'نام شما', 0),
(1390, 0, 'config', 'config_name', 'فروشگاه شما', 0),
(1490, 0, 'config', 'config_seo_url', '0', 0),
(1491, 0, 'config', 'config_file_max_size', '300000', 0),
(1492, 0, 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', 0),
(1493, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\n&quot;application/zip&quot;\r\napplication/x-zip\r\n&quot;application/x-zip&quot;\r\napplication/x-zip-compressed\r\n&quot;application/x-zip-compressed&quot;\r\napplication/rar\r\n&quot;application/rar&quot;\r\napplication/x-rar\r\n&quot;application/x-rar&quot;\r\napplication/x-rar-compressed\r\n&quot;application/x-rar-compressed&quot;\r\napplication/octet-stream\r\n&quot;application/octet-stream&quot;\r\naudio/mpeg\r\nvideo/quicktime\r\napplication/pdf', 0),
(1494, 0, 'config', 'config_maintenance', '0', 0),
(1495, 0, 'config', 'config_password', '1', 0),
(1496, 0, 'config', 'config_encryption', '3e0a42fd41712b6a90844a056780f8dc', 0),
(1497, 0, 'config', 'config_compression', '0', 0),
(1498, 0, 'config', 'config_error_display', '1', 0),
(1499, 0, 'config', 'config_error_log', '1', 0),
(1500, 0, 'config', 'config_error_filename', 'error.log', 0),
(1501, 0, 'config', 'config_google_analytics', '', 0),
(1502, 0, 'config', 'config_google_analytics_status', '0', 0),
(1503, 0, 'config', 'config_google_captcha_public', '', 0),
(1504, 0, 'config', 'config_google_captcha_secret', '', 0),
(1505, 0, 'config', 'config_google_captcha_status', '0', 0);

-- --------------------------------------------------------

--
-- Table structure for table `ek_stock_status`
--

CREATE TABLE `ek_stock_status` (
  `stock_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `ek_stock_status`
--

INSERT INTO `ek_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7, 1, 'In Stock'),
(5, 1, 'Out Of Stock'),
(7, 2, 'موجود'),
(8, 2, 'پیش سفارش'),
...
--
-- Table structure for table `ek_store`
--

CREATE TABLE `ek_store` (
  `store_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Table structure for table `ek_tax_class`
--

CREATE TABLE `ek_tax_class` (
  `tax_class_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
  `description` varchar(255) NOT NULL,
  `date_added` datetime NOT NULL,
...
--
-- Dumping data for table `ek_tax_class`
--

INSERT INTO `ek_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `ek_tax_rate`
--

CREATE TABLE `ek_tax_rate` (
...
--
-- Dumping data for table `ek_tax_rate`
--

INSERT INTO `ek_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `ek_tax_rate_to_customer_group`
--

CREATE TABLE `ek_tax_rate_to_customer_group` (
  `tax_rate_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ek_tax_rate_to_customer_group`
--

INSERT INTO `ek_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 1),
(87, 1);
...
--
-- Table structure for table `ek_tax_rule`
--

CREATE TABLE `ek_tax_rule` (
...
--
-- Dumping data for table `ek_tax_rule`
--

INSERT INTO `ek_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(129, 10, 86, 'payment', 1),
(132, 9, 87, 'shipping', 2),
(131, 9, 86, 'shipping', 1),
(130, 10, 87, 'store', 0);
...
--
-- Table structure for table `ek_upload`
--

CREATE TABLE `ek_upload` (
...
--
-- Table structure for table `ek_url_alias`
--

CREATE TABLE `ek_url_alias` (
...
--
-- Dumping data for table `ek_url_alias`
--

INSERT INTO `ek_url_alias` (`url_alias_id`, `query`, `keyword`) VALUES
...
--
-- Table structure for table `ek_user`
--
...
--
-- Dumping data for table `ek_user`
--

INSERT INTO `ek_user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `image`, `code`, `ip`, `status`, `date_added`) VALUES
(1, 1, 'admin', '8ac93de6437c18d046834dc3f70ea1492579917c', '53ccfa7ee', 'اپن کارت', 'فارسی', 'smd@smd.smd', '', '', '10.130.6.1', 1, '2020-02-11 12:43:43');

-- --------------------------------------------------------

--
-- Table structure for table `ek_user_group`
--

CREATE TABLE `ek_user_group` (
  `user_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Dumping data for table `ek_user_group`
--

INSERT INTO `ek_user_group` (`user_group_id`, `name`, `permission`) VALUES
...
--
-- Table structure for table `ek_voucher`
--

CREATE TABLE `ek_voucher` (
  `voucher_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `code` varchar(10) NOT NULL,
  `from_name` varchar(64) NOT NULL,
...
--
-- Table structure for table `ek_voucher_history`
--

CREATE TABLE `ek_voucher_history` (
...
--
-- Table structure for table `ek_voucher_theme`
--

CREATE TABLE `ek_voucher_theme` (
  `voucher_theme_id` int(11) NOT NULL,
  `image` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ek_voucher_theme`
--

INSERT INTO `ek_voucher_theme` (`voucher_theme_id`, `image`) VALUES
...
--
-- Table structure for table `ek_voucher_theme_description`
--

CREATE TABLE `ek_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `ek_voucher_theme_description`
--

INSERT INTO `ek_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(7, 1, 'Birthday'),
(6, 2, 'کریسمس'),
(7, 2, 'تولد'),
(8, 2, 'عمومی'),
...
--
-- Table structure for table `ek_weight_class`
--

CREATE TABLE `ek_weight_class` (
  `weight_class_id` int(11) NOT NULL,
  `value` decimal(15,8) NOT NULL DEFAULT '0.00000000'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `ek_weight_class`
--

INSERT INTO `ek_weight_class` (`weight_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '1000.00000000'),
(5, '2.20460000'),
(6, '35.27400000');
...
--
-- Table structure for table `ek_weight_class_description`
--

CREATE TABLE `ek_weight_class_description` (
  `weight_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
  `unit` varchar(4) NOT NULL
...
--
-- Dumping data for table `ek_weight_class_description`
--

INSERT INTO `ek_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(5, 1, 'Pound ', 'lb'),
(6, 1, 'Ounce', 'oz'),
(1, 2, 'کیلوگرم', 'kg'),
(2, 2, 'گرم', 'g'),
...
--
-- Table structure for table `ek_zone`
--

CREATE TABLE `ek_zone` (
  `zone_id` int(11) NOT NULL,
  `country_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL,
  `code` varchar(32) NOT NULL,
...
--
-- Dumping data for table `ek_zone`
--

INSERT INTO `ek_zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
...
--
-- Table structure for table `ek_zone_to_geo_zone`
--

CREATE TABLE `ek_zone_to_geo_zone` (
...
--
-- Dumping data for table `ek_zone_to_geo_zone`
--

INSERT INTO `ek_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
...
--
-- Indexes for table `ek_address`
--
ALTER TABLE `ek_address`
  ADD PRIMARY KEY (`address_id`),
  ADD KEY `customer_id` (`customer_id`);

--
-- Indexes for table `ek_affiliate`
--
ALTER TABLE `ek_affiliate`
  ADD PRIMARY KEY (`affiliate_id`);

--
-- Indexes for table `ek_affiliate_activity`
--
ALTER TABLE `ek_affiliate_activity`
  ADD PRIMARY KEY (`activity_id`);

--
-- Indexes for table `ek_affiliate_login`
--
ALTER TABLE `ek_affiliate_login`
  ADD PRIMARY KEY (`affiliate_login_id`),
  ADD KEY `email` (`email`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `ek_affiliate_transaction`
--
ALTER TABLE `ek_affiliate_transaction`
  ADD PRIMARY KEY (`affiliate_transaction_id`);

--
-- Indexes for table `ek_api`
--
ALTER TABLE `ek_api`
  ADD PRIMARY KEY (`api_id`);

--
-- Indexes for table `ek_attribute`
--
ALTER TABLE `ek_attribute`
  ADD PRIMARY KEY (`attribute_id`);

--
-- Indexes for table `ek_attribute_description`
--
ALTER TABLE `ek_attribute_description`
  ADD PRIMARY KEY (`attribute_id`,`language_id`);

--
-- Indexes for table `ek_attribute_group`
--
ALTER TABLE `ek_attribute_group`
  ADD PRIMARY KEY (`attribute_group_id`);

--
-- Indexes for table `ek_attribute_group_description`
--
ALTER TABLE `ek_attribute_group_description`
  ADD PRIMARY KEY (`attribute_group_id`,`language_id`);

--
-- Indexes for table `ek_banner`
--
ALTER TABLE `ek_banner`
  ADD PRIMARY KEY (`banner_id`);

--
-- Indexes for table `ek_banner_image`
--
ALTER TABLE `ek_banner_image`
  ADD PRIMARY KEY (`banner_image_id`);

--
-- Indexes for table `ek_banner_image_description`
--
ALTER TABLE `ek_banner_image_description`
  ADD PRIMARY KEY (`banner_image_id`,`language_id`);

--
-- Indexes for table `ek_category`
--
ALTER TABLE `ek_category`
  ADD PRIMARY KEY (`category_id`),
  ADD KEY `parent_id` (`parent_id`);

--
-- Indexes for table `ek_category_description`
--
ALTER TABLE `ek_category_description`
  ADD PRIMARY KEY (`category_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `ek_category_filter`
--
ALTER TABLE `ek_category_filter`
  ADD PRIMARY KEY (`category_id`,`filter_id`);

--
-- Indexes for table `ek_category_path`
--
ALTER TABLE `ek_category_path`
  ADD PRIMARY KEY (`category_id`,`path_id`);

--
-- Indexes for table `ek_category_to_layout`
--
ALTER TABLE `ek_category_to_layout`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `ek_category_to_store`
--
ALTER TABLE `ek_category_to_store`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indexes for table `ek_country`
--
ALTER TABLE `ek_country`
  ADD PRIMARY KEY (`country_id`);

--
-- Indexes for table `ek_coupon`
--
ALTER TABLE `ek_coupon`
  ADD PRIMARY KEY (`coupon_id`);

--
-- Indexes for table `ek_coupon_category`
--
ALTER TABLE `ek_coupon_category`
  ADD PRIMARY KEY (`coupon_id`,`category_id`);

--
-- Indexes for table `ek_coupon_history`
--
ALTER TABLE `ek_coupon_history`
  ADD PRIMARY KEY (`coupon_history_id`);

--
-- Indexes for table `ek_coupon_product`
--
ALTER TABLE `ek_coupon_product`
  ADD PRIMARY KEY (`coupon_product_id`);

--
-- Indexes for table `ek_currency`
--
ALTER TABLE `ek_currency`
  ADD PRIMARY KEY (`currency_id`);

--
-- Indexes for table `ek_customer`
--
ALTER TABLE `ek_customer`
  ADD PRIMARY KEY (`customer_id`);

--
-- Indexes for table `ek_customer_activity`
--
ALTER TABLE `ek_customer_activity`
  ADD PRIMARY KEY (`activity_id`);

--
-- Indexes for table `ek_customer_ban_ip`
--
ALTER TABLE `ek_customer_ban_ip`
  ADD PRIMARY KEY (`customer_ban_ip_id`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `ek_customer_group`
--
ALTER TABLE `ek_customer_group`
  ADD PRIMARY KEY (`customer_group_id`);

--
-- Indexes for table `ek_customer_group_description`
--
ALTER TABLE `ek_customer_group_description`
  ADD PRIMARY KEY (`customer_group_id`,`language_id`);

--
-- Indexes for table `ek_customer_history`
--
ALTER TABLE `ek_customer_history`
  ADD PRIMARY KEY (`customer_history_id`);

--
-- Indexes for table `ek_customer_ip`
--
ALTER TABLE `ek_customer_ip`
  ADD PRIMARY KEY (`customer_ip_id`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `ek_customer_login`
--
ALTER TABLE `ek_customer_login`
  ADD PRIMARY KEY (`customer_login_id`),
  ADD KEY `email` (`email`),
  ADD KEY `ip` (`ip`);

--
-- Indexes for table `ek_customer_online`
--
ALTER TABLE `ek_customer_online`
  ADD PRIMARY KEY (`ip`);

--
-- Indexes for table `ek_customer_reward`
--
ALTER TABLE `ek_customer_reward`
  ADD PRIMARY KEY (`customer_reward_id`);

--
-- Indexes for table `ek_customer_transaction`
--
ALTER TABLE `ek_customer_transaction`
  ADD PRIMARY KEY (`customer_transaction_id`);

--
-- Indexes for table `ek_custom_field`
--
ALTER TABLE `ek_custom_field`
  ADD PRIMARY KEY (`custom_field_id`);

--
-- Indexes for table `ek_custom_field_customer_group`
--
ALTER TABLE `ek_custom_field_customer_group`
  ADD PRIMARY KEY (`custom_field_id`,`customer_group_id`);

--
-- Indexes for table `ek_custom_field_description`
--
ALTER TABLE `ek_custom_field_description`
  ADD PRIMARY KEY (`custom_field_id`,`language_id`);

--
-- Indexes for table `ek_custom_field_value`
--
ALTER TABLE `ek_custom_field_value`
  ADD PRIMARY KEY (`custom_field_value_id`);

--
-- Indexes for table `ek_custom_field_value_description`
--
ALTER TABLE `ek_custom_field_value_description`
  ADD PRIMARY KEY (`custom_field_value_id`,`language_id`);

--
-- Indexes for table `ek_download`
--
ALTER TABLE `ek_download`
  ADD PRIMARY KEY (`download_id`);

--
-- Indexes for table `ek_download_description`
--
ALTER TABLE `ek_download_description`
  ADD PRIMARY KEY (`download_id`,`language_id`);

--
-- Indexes for table `ek_event`
--
ALTER TABLE `ek_event`
  ADD PRIMARY KEY (`event_id`);

--
-- Indexes for table `ek_extension`
--
ALTER TABLE `ek_extension`
  ADD PRIMARY KEY (`extension_id`);

--
-- Indexes for table `ek_filter`
--
ALTER TABLE `ek_filter`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `ek_filter_description`
--
ALTER TABLE `ek_filter_description`
  ADD PRIMARY KEY (`filter_id`,`language_id`);

--
-- Indexes for table `ek_filter_group`
--
ALTER TABLE `ek_filter_group`
  ADD PRIMARY KEY (`filter_group_id`);

--
-- Indexes for table `ek_filter_group_description`
--
ALTER TABLE `ek_filter_group_description`
  ADD PRIMARY KEY (`filter_group_id`,`language_id`);

--
-- Indexes for table `ek_geo_zone`
--
ALTER TABLE `ek_geo_zone`
  ADD PRIMARY KEY (`geo_zone_id`);

--
-- Indexes for table `ek_information`
--
ALTER TABLE `ek_information`
  ADD PRIMARY KEY (`information_id`);

--
-- Indexes for table `ek_information_description`
--
ALTER TABLE `ek_information_description`
  ADD PRIMARY KEY (`information_id`,`language_id`);

--
-- Indexes for table `ek_information_to_layout`
--
ALTER TABLE `ek_information_to_layout`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Indexes for table `ek_information_to_store`
--
ALTER TABLE `ek_information_to_store`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Indexes for table `ek_language`
--
ALTER TABLE `ek_language`
  ADD PRIMARY KEY (`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `ek_layout`
--
ALTER TABLE `ek_layout`
  ADD PRIMARY KEY (`layout_id`);

--
-- Indexes for table `ek_layout_module`
--
ALTER TABLE `ek_layout_module`
  ADD PRIMARY KEY (`layout_module_id`);

--
-- Indexes for table `ek_layout_route`
--
ALTER TABLE `ek_layout_route`
  ADD PRIMARY KEY (`layout_route_id`);

--
-- Indexes for table `ek_length_class`
--
ALTER TABLE `ek_length_class`
  ADD PRIMARY KEY (`length_class_id`);

--
-- Indexes for table `ek_length_class_description`
--
ALTER TABLE `ek_length_class_description`
  ADD PRIMARY KEY (`length_class_id`,`language_id`);

--
-- Indexes for table `ek_location`
--
ALTER TABLE `ek_location`
  ADD PRIMARY KEY (`location_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `ek_manufacturer`
--
ALTER TABLE `ek_manufacturer`
  ADD PRIMARY KEY (`manufacturer_id`);

--
-- Indexes for table `ek_manufacturer_to_store`
--
ALTER TABLE `ek_manufacturer_to_store`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Indexes for table `ek_marketing`
--
ALTER TABLE `ek_marketing`
  ADD PRIMARY KEY (`marketing_id`);

--
-- Indexes for table `ek_modification`
--
ALTER TABLE `ek_modification`
  ADD PRIMARY KEY (`modification_id`);

--
-- Indexes for table `ek_module`
--
ALTER TABLE `ek_module`
  ADD PRIMARY KEY (`module_id`);

--
-- Indexes for table `ek_option`
--
ALTER TABLE `ek_option`
  ADD PRIMARY KEY (`option_id`);

--
-- Indexes for table `ek_option_description`
--
ALTER TABLE `ek_option_description`
  ADD PRIMARY KEY (`option_id`,`language_id`);

--
-- Indexes for table `ek_option_value`
--
ALTER TABLE `ek_option_value`
  ADD PRIMARY KEY (`option_value_id`);

--
-- Indexes for table `ek_option_value_description`
--
ALTER TABLE `ek_option_value_description`
  ADD PRIMARY KEY (`option_value_id`,`language_id`);

--
-- Indexes for table `ek_order`
--
ALTER TABLE `ek_order`
  ADD PRIMARY KEY (`order_id`);

--
-- Indexes for table `ek_order_custom_field`
--
ALTER TABLE `ek_order_custom_field`
  ADD PRIMARY KEY (`order_custom_field_id`);

--
-- Indexes for table `ek_order_history`
--
ALTER TABLE `ek_order_history`
  ADD PRIMARY KEY (`order_history_id`);

--
-- Indexes for table `ek_order_option`
--
ALTER TABLE `ek_order_option`
  ADD PRIMARY KEY (`order_option_id`);

--
-- Indexes for table `ek_order_product`
--
ALTER TABLE `ek_order_product`
  ADD PRIMARY KEY (`order_product_id`);

--
-- Indexes for table `ek_order_recurring`
--
ALTER TABLE `ek_order_recurring`
  ADD PRIMARY KEY (`order_recurring_id`);

--
-- Indexes for table `ek_order_recurring_transaction`
--
ALTER TABLE `ek_order_recurring_transaction`
  ADD PRIMARY KEY (`order_recurring_transaction_id`);

--
-- Indexes for table `ek_order_status`
--
ALTER TABLE `ek_order_status`
  ADD PRIMARY KEY (`order_status_id`,`language_id`);

--
-- Indexes for table `ek_order_total`
--
ALTER TABLE `ek_order_total`
  ADD PRIMARY KEY (`order_total_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `ek_order_voucher`
--
ALTER TABLE `ek_order_voucher`
  ADD PRIMARY KEY (`order_voucher_id`);

--
-- Indexes for table `ek_product`
--
ALTER TABLE `ek_product`
  ADD PRIMARY KEY (`product_id`);

--
-- Indexes for table `ek_product_attribute`
--
ALTER TABLE `ek_product_attribute`
  ADD PRIMARY KEY (`product_id`,`attribute_id`,`language_id`);

--
-- Indexes for table `ek_product_description`
--
ALTER TABLE `ek_product_description`
  ADD PRIMARY KEY (`product_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- Indexes for table `ek_product_discount`
--
ALTER TABLE `ek_product_discount`
  ADD PRIMARY KEY (`product_discount_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `ek_product_filter`
--
ALTER TABLE `ek_product_filter`
  ADD PRIMARY KEY (`product_id`,`filter_id`);

--
-- Indexes for table `ek_product_image`
--
ALTER TABLE `ek_product_image`
  ADD PRIMARY KEY (`product_image_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `ek_product_option`
--
ALTER TABLE `ek_product_option`
  ADD PRIMARY KEY (`product_option_id`);

--
-- Indexes for table `ek_product_option_value`
--
ALTER TABLE `ek_product_option_value`
  ADD PRIMARY KEY (`product_option_value_id`);

--
-- Indexes for table `ek_product_recurring`
--
ALTER TABLE `ek_product_recurring`
  ADD PRIMARY KEY (`product_id`,`recurring_id`,`customer_group_id`);

--
-- Indexes for table `ek_product_related`
--
ALTER TABLE `ek_product_related`
  ADD PRIMARY KEY (`product_id`,`related_id`);

--
-- Indexes for table `ek_product_reward`
--
ALTER TABLE `ek_product_reward`
  ADD PRIMARY KEY (`product_reward_id`);

--
-- Indexes for table `ek_product_special`
--
ALTER TABLE `ek_product_special`
  ADD PRIMARY KEY (`product_special_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `ek_product_to_category`
--
ALTER TABLE `ek_product_to_category`
  ADD PRIMARY KEY (`product_id`,`category_id`),
  ADD KEY `category_id` (`category_id`);

--
-- Indexes for table `ek_product_to_download`
--
ALTER TABLE `ek_product_to_download`
  ADD PRIMARY KEY (`product_id`,`download_id`);

--
-- Indexes for table `ek_product_to_layout`
--
ALTER TABLE `ek_product_to_layout`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indexes for table `ek_product_to_store`
--
ALTER TABLE `ek_product_to_store`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indexes for table `ek_recurring`
--
ALTER TABLE `ek_recurring`
  ADD PRIMARY KEY (`recurring_id`);

--
-- Indexes for table `ek_recurring_description`
--
ALTER TABLE `ek_recurring_description`
  ADD PRIMARY KEY (`recurring_id`,`language_id`);

--
-- Indexes for table `ek_return`
--
ALTER TABLE `ek_return`
  ADD PRIMARY KEY (`return_id`);

--
-- Indexes for table `ek_return_action`
--
ALTER TABLE `ek_return_action`
  ADD PRIMARY KEY (`return_action_id`,`language_id`);

--
-- Indexes for table `ek_return_history`
--
ALTER TABLE `ek_return_history`
  ADD PRIMARY KEY (`return_history_id`);

--
-- Indexes for table `ek_return_reason`
--
ALTER TABLE `ek_return_reason`
  ADD PRIMARY KEY (`return_reason_id`,`language_id`);

--
-- Indexes for table `ek_return_status`
--
ALTER TABLE `ek_return_status`
  ADD PRIMARY KEY (`return_status_id`,`language_id`);

--
-- Indexes for table `ek_review`
--
ALTER TABLE `ek_review`
  ADD PRIMARY KEY (`review_id`),
  ADD KEY `product_id` (`product_id`);

--
-- Indexes for table `ek_setting`
--
ALTER TABLE `ek_setting`
  ADD PRIMARY KEY (`setting_id`);

--
-- Indexes for table `ek_stock_status`
--
ALTER TABLE `ek_stock_status`
  ADD PRIMARY KEY (`stock_status_id`,`language_id`);

--
-- Indexes for table `ek_store`
--
ALTER TABLE `ek_store`
  ADD PRIMARY KEY (`store_id`);

--
-- Indexes for table `ek_tax_class`
--
ALTER TABLE `ek_tax_class`
  ADD PRIMARY KEY (`tax_class_id`);

--
-- Indexes for table `ek_tax_rate`
--
ALTER TABLE `ek_tax_rate`
  ADD PRIMARY KEY (`tax_rate_id`);

--
-- Indexes for table `ek_tax_rate_to_customer_group`
--
ALTER TABLE `ek_tax_rate_to_customer_group`
  ADD PRIMARY KEY (`tax_rate_id`,`customer_group_id`);

--
-- Indexes for table `ek_tax_rule`
--
ALTER TABLE `ek_tax_rule`
  ADD PRIMARY KEY (`tax_rule_id`);

--
-- Indexes for table `ek_upload`
--
ALTER TABLE `ek_upload`
  ADD PRIMARY KEY (`upload_id`);

--
-- Indexes for table `ek_url_alias`
--
ALTER TABLE `ek_url_alias`
  ADD PRIMARY KEY (`url_alias_id`),
  ADD KEY `query` (`query`),
  ADD KEY `keyword` (`keyword`);

--
-- Indexes for table `ek_user`
--
ALTER TABLE `ek_user`
  ADD PRIMARY KEY (`user_id`);

--
-- Indexes for table `ek_user_group`
--
ALTER TABLE `ek_user_group`
  ADD PRIMARY KEY (`user_group_id`);

--
-- Indexes for table `ek_voucher`
--
ALTER TABLE `ek_voucher`
  ADD PRIMARY KEY (`voucher_id`);

--
-- Indexes for table `ek_voucher_history`
--
ALTER TABLE `ek_voucher_history`
  ADD PRIMARY KEY (`voucher_history_id`);

--
-- Indexes for table `ek_voucher_theme`
--
ALTER TABLE `ek_voucher_theme`
  ADD PRIMARY KEY (`voucher_theme_id`);

--
-- Indexes for table `ek_voucher_theme_description`
--
ALTER TABLE `ek_voucher_theme_description`
  ADD PRIMARY KEY (`voucher_theme_id`,`language_id`);

--
-- Indexes for table `ek_weight_class`
--
ALTER TABLE `ek_weight_class`
  ADD PRIMARY KEY (`weight_class_id`);

--
-- Indexes for table `ek_weight_class_description`
--
ALTER TABLE `ek_weight_class_description`
  ADD PRIMARY KEY (`weight_class_id`,`language_id`);

--
-- Indexes for table `ek_zone`
--
ALTER TABLE `ek_zone`
  ADD PRIMARY KEY (`zone_id`);

--
-- Indexes for table `ek_zone_to_geo_zone`
--
ALTER TABLE `ek_zone_to_geo_zone`
...
--
-- AUTO_INCREMENT for table `ek_address`
--
ALTER TABLE `ek_address`
  MODIFY `address_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_affiliate`
--
ALTER TABLE `ek_affiliate`
  MODIFY `affiliate_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_affiliate_activity`
--
ALTER TABLE `ek_affiliate_activity`
  MODIFY `activity_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_affiliate_login`
--
ALTER TABLE `ek_affiliate_login`
  MODIFY `affiliate_login_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_affiliate_transaction`
--
ALTER TABLE `ek_affiliate_transaction`
  MODIFY `affiliate_transaction_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_api`
--
ALTER TABLE `ek_api`
  MODIFY `api_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `ek_attribute`
--
ALTER TABLE `ek_attribute`
  MODIFY `attribute_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `ek_attribute_group`
--
ALTER TABLE `ek_attribute_group`
  MODIFY `attribute_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `ek_banner`
--
ALTER TABLE `ek_banner`
  MODIFY `banner_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `ek_banner_image`
--
ALTER TABLE `ek_banner_image`
  MODIFY `banner_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=126;

--
-- AUTO_INCREMENT for table `ek_category`
--
ALTER TABLE `ek_category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT for table `ek_country`
--
ALTER TABLE `ek_country`
  MODIFY `country_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT for table `ek_coupon`
--
ALTER TABLE `ek_coupon`
  MODIFY `coupon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `ek_coupon_history`
--
ALTER TABLE `ek_coupon_history`
  MODIFY `coupon_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_coupon_product`
--
ALTER TABLE `ek_coupon_product`
  MODIFY `coupon_product_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_currency`
--
ALTER TABLE `ek_currency`
  MODIFY `currency_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `ek_customer`
--
ALTER TABLE `ek_customer`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_customer_activity`
--
ALTER TABLE `ek_customer_activity`
  MODIFY `activity_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_customer_ban_ip`
--
ALTER TABLE `ek_customer_ban_ip`
  MODIFY `customer_ban_ip_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_customer_group`
--
ALTER TABLE `ek_customer_group`
  MODIFY `customer_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `ek_customer_history`
--
ALTER TABLE `ek_customer_history`
  MODIFY `customer_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_customer_ip`
--
ALTER TABLE `ek_customer_ip`
  MODIFY `customer_ip_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_customer_login`
--
ALTER TABLE `ek_customer_login`
  MODIFY `customer_login_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_customer_reward`
--
ALTER TABLE `ek_customer_reward`
  MODIFY `customer_reward_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_customer_transaction`
--
ALTER TABLE `ek_customer_transaction`
  MODIFY `customer_transaction_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_custom_field`
--
ALTER TABLE `ek_custom_field`
  MODIFY `custom_field_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_custom_field_value`
--
ALTER TABLE `ek_custom_field_value`
  MODIFY `custom_field_value_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_download`
--
ALTER TABLE `ek_download`
  MODIFY `download_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_event`
--
ALTER TABLE `ek_event`
  MODIFY `event_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_extension`
--
ALTER TABLE `ek_extension`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=430;

--
-- AUTO_INCREMENT for table `ek_filter`
--
ALTER TABLE `ek_filter`
  MODIFY `filter_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_filter_group`
--
ALTER TABLE `ek_filter_group`
  MODIFY `filter_group_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_geo_zone`
--
ALTER TABLE `ek_geo_zone`
  MODIFY `geo_zone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `ek_information`
--
ALTER TABLE `ek_information`
  MODIFY `information_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `ek_language`
--
ALTER TABLE `ek_language`
  MODIFY `language_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `ek_layout`
--
ALTER TABLE `ek_layout`
  MODIFY `layout_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `ek_layout_module`
--
ALTER TABLE `ek_layout_module`
  MODIFY `layout_module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;

--
-- AUTO_INCREMENT for table `ek_layout_route`
--
ALTER TABLE `ek_layout_route`
  MODIFY `layout_route_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `ek_length_class`
--
ALTER TABLE `ek_length_class`
  MODIFY `length_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `ek_length_class_description`
--
ALTER TABLE `ek_length_class_description`
  MODIFY `length_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `ek_location`
--
ALTER TABLE `ek_location`
  MODIFY `location_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_manufacturer`
--
ALTER TABLE `ek_manufacturer`
  MODIFY `manufacturer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `ek_marketing`
--
ALTER TABLE `ek_marketing`
  MODIFY `marketing_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_modification`
--
ALTER TABLE `ek_modification`
  MODIFY `modification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `ek_module`
--
ALTER TABLE `ek_module`
  MODIFY `module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `ek_option`
--
ALTER TABLE `ek_option`
  MODIFY `option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `ek_option_value`
--
ALTER TABLE `ek_option_value`
  MODIFY `option_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT for table `ek_order`
--
ALTER TABLE `ek_order`
  MODIFY `order_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_order_custom_field`
--
ALTER TABLE `ek_order_custom_field`
  MODIFY `order_custom_field_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_order_history`
--
ALTER TABLE `ek_order_history`
  MODIFY `order_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_order_option`
--
ALTER TABLE `ek_order_option`
  MODIFY `order_option_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_order_product`
--
ALTER TABLE `ek_order_product`
  MODIFY `order_product_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_order_recurring`
--
ALTER TABLE `ek_order_recurring`
  MODIFY `order_recurring_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_order_recurring_transaction`
--
ALTER TABLE `ek_order_recurring_transaction`
  MODIFY `order_recurring_transaction_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_order_status`
--
ALTER TABLE `ek_order_status`
  MODIFY `order_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `ek_order_total`
--
ALTER TABLE `ek_order_total`
  MODIFY `order_total_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_order_voucher`
--
ALTER TABLE `ek_order_voucher`
  MODIFY `order_voucher_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_product`
--
ALTER TABLE `ek_product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT for table `ek_product_discount`
--
ALTER TABLE `ek_product_discount`
  MODIFY `product_discount_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=450;

--
-- AUTO_INCREMENT for table `ek_product_image`
--
ALTER TABLE `ek_product_image`
  MODIFY `product_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2431;

--
-- AUTO_INCREMENT for table `ek_product_option`
--
ALTER TABLE `ek_product_option`
  MODIFY `product_option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=227;

--
-- AUTO_INCREMENT for table `ek_product_option_value`
--
ALTER TABLE `ek_product_option_value`
  MODIFY `product_option_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `ek_product_reward`
--
ALTER TABLE `ek_product_reward`
  MODIFY `product_reward_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=556;

--
-- AUTO_INCREMENT for table `ek_product_special`
--
ALTER TABLE `ek_product_special`
  MODIFY `product_special_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=445;

--
-- AUTO_INCREMENT for table `ek_recurring`
--
ALTER TABLE `ek_recurring`
  MODIFY `recurring_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_return`
--
ALTER TABLE `ek_return`
  MODIFY `return_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_return_action`
--
ALTER TABLE `ek_return_action`
  MODIFY `return_action_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `ek_return_history`
--
ALTER TABLE `ek_return_history`
  MODIFY `return_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_return_reason`
--
ALTER TABLE `ek_return_reason`
  MODIFY `return_reason_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `ek_return_status`
--
ALTER TABLE `ek_return_status`
  MODIFY `return_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `ek_review`
--
ALTER TABLE `ek_review`
  MODIFY `review_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_setting`
--
ALTER TABLE `ek_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1506;

--
-- AUTO_INCREMENT for table `ek_stock_status`
--
ALTER TABLE `ek_stock_status`
  MODIFY `stock_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `ek_store`
--
ALTER TABLE `ek_store`
  MODIFY `store_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_tax_class`
--
ALTER TABLE `ek_tax_class`
  MODIFY `tax_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `ek_tax_rate`
--
ALTER TABLE `ek_tax_rate`
  MODIFY `tax_rate_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;

--
-- AUTO_INCREMENT for table `ek_tax_rule`
--
ALTER TABLE `ek_tax_rule`
  MODIFY `tax_rule_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;

--
-- AUTO_INCREMENT for table `ek_upload`
--
ALTER TABLE `ek_upload`
  MODIFY `upload_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_url_alias`
--
ALTER TABLE `ek_url_alias`
  MODIFY `url_alias_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=920;

--
-- AUTO_INCREMENT for table `ek_user`
--
ALTER TABLE `ek_user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `ek_user_group`
--
ALTER TABLE `ek_user_group`
  MODIFY `user_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `ek_voucher`
--
ALTER TABLE `ek_voucher`
  MODIFY `voucher_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_voucher_history`
--
ALTER TABLE `ek_voucher_history`
  MODIFY `voucher_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ek_voucher_theme`
--
ALTER TABLE `ek_voucher_theme`
  MODIFY `voucher_theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `ek_weight_class`
--
ALTER TABLE `ek_weight_class`
  MODIFY `weight_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `ek_weight_class_description`
--
ALTER TABLE `ek_weight_class_description`
  MODIFY `weight_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `ek_zone`
--
ALTER TABLE `ek_zone`
  MODIFY `zone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3970;

--
-- AUTO_INCREMENT for table `ek_zone_to_geo_zone`
--
ALTER TABLE `ek_zone_to_geo_zone`
